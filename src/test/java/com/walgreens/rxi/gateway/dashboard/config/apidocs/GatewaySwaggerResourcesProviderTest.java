package com.walgreens.rxi.gateway.dashboard.config.apidocs;

import static com.walgreens.rxi.gateway.dashboard.config.apidocs.GatewaySwaggerResourcesProvider.swaggerResource;

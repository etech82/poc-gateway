...
describe('Product e2e test', () => {
  ...
  it('should load Products', async () => {
    ...
    expect(await productComponentsPage.getTitle()).to.eq('gatewayApp.inventoryProduct.home.title');
  ...
  it('should load create Product page', async () => {
    ...
    expect(await productUpdatePage.getPageTitle()).to.eq('gatewayApp.inventoryProduct.home.createOrEditLabel');
  ...
  it('should create and save Products', async () => {
    ...
    await promise.all([
      ...
      productUpdatePage.setCompanyInput('company'),
      productUpdatePage.typeSelectLastOption(),
      productUpdatePage.storageTypeSelectLastOption(),
      ...
      productUpdatePage.productCodeSelectLastOption(),
      productUpdatePage.categorySelectLastOption(),
      productUpdatePage.packagingSelectLastOption(),
    ]);
    ...
    expect(await productUpdatePage.getCompanyInput()).to.eq('company', 'Expected Company value to be equals to company');
  ...
  it('should delete last Product', async () => {
    ...
    expect(await productDeleteDialog.getDialogTitle()).to.eq('gatewayApp.inventoryProduct.delete.question');
